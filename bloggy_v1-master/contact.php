                   ...
                   <div class="alert alert-success"id="notif" style="display:none">
					 ...
					 <form class="form-horizontal" action="contact_action.php" method="post">
					  <div class="form-group has-feedback">
					    ...
					    <div class="col-sm-10"><input type="email" class="form-control" id="email" name="email" required="required" value="achraf_bra@hotmail.fr"> 
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"><input type="text" class="form-control" id="sujet" name="sujet" required="required" value="test"> </div>
					  </div>

					  <div class="form-group">
					  	<label class="control-label col-sm-2" for="message">Message *:</label>
					  	<div class="col-sm-10"><textarea class="form-control" required="required" id="message" name="message" >alertmerci</textarea> </div>
					  </div>
